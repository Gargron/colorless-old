    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot, tit) {
            ...
            rect.hover(function () {
                ...
                label[1].attr({text: tit}).show().stop().animateWith(frame, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible);
                dot.attr("r", 6);
        ...
        })(x, y, data[i], labels[i], dot, title[i]);
    }
    p = p.concat([x, y, x, y]);
